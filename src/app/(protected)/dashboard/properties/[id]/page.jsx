      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
        <div>
          ...
          <div className="flex items-center gap-2 group">
            ...
            {permissions.canEditProperty && isEditingName ? (
              <input
                autoFocus
                value={nameDraft}
              ...
              <>
                ...
                <h1
                  onClick={() =>
                    permissions.canEditProperty && setIsEditingName(true)
                  }
        ...
        {permissions.canSetLocation ? (
          <div className="mt-2 text-sm text-gray-600">
            ...
            <input
              ...
              onBlur={async () => {
                try {
                  await fetch(`/api/dashboard/properties/${propertyId}`, {
                    method: "PATCH",
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          {permissions.canSetLocation && (
            <button
              onClick={() =>
                router.push(`/dashboard/properties/${propertyId}/set-location`)
              }
