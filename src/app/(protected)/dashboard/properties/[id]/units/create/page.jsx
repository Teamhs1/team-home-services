...
export default function CreateUnitPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const res = await fetch(`/api/dashboard/properties/${propertyId}/units`, {
        method: "POST",
        credentials: "include",
      ...
      if (!res.ok) {
        ...
        toast.error(json.error || "Failed to create units");
        return;
      }
      ...
      {limitModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl p-6 max-w-md w-full shadow-xl space-y-4">
            <h2 className="text-xl font-semibold">Unit limit reached</h2>

            <p className="text-sm text-gray-600">
              Your <b>{limitModal.plan}</b> plan allows up to{" "}
              <b>{limitModal.limit}</b> units.
            </p>
