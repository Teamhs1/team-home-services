...
export default function CreateKeyPage() {
  ...
  async function loadProperties(companyId) {
    ...
    try {
      const res = await fetch(`/api/properties?company_id=${companyId}`, {
        cache: "no-store",
        credentials: "include",
      });
  ...
  if (loadingContext) {
    return (
      <main className="px-4 sm:px-6 pt-[130px] max-w-xl mx-auto text-center text-gray-500">
        Loading...
      </main>
    );
  }
      ...
      <main className="px-4 sm:px-6 pt-[150px] max-w-xl mx-auto">
        <div className="flex flex-col items-center text-center space-y-6">
          <div className="w-full bg-red-50 border border-red-200 text-red-700 px-6 py-5 rounded-xl">
            Billing is disabled for this company. Keys cannot be created.
          </div>
